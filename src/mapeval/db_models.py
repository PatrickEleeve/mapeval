...
if SQLALCHEMY_AVAILABLE:
    ...
    class SessionRecord(Base):
        ...
        decisions = relationship(
            "DecisionRecord", back_populates="session", cascade="all, delete-orphan"
        )
        equity_snapshots = relationship(
            "EquitySnapshot", back_populates="session", cascade="all, delete-orphan"
        )
    ...
    class TradeRecord(Base):
        ...
        )  # open, close, increase, reduce, etc.
    ...
    class DecisionRecord(Base):
        ...
        __table_args__ = (Index("idx_decisions_session_time", "session_id", "timestamp"),)
        ...
        requested_exposures: Mapped[str | None] = mapped_column(Text, nullable=True)  # JSON
        applied_exposures: Mapped[str | None] = mapped_column(Text, nullable=True)  # JSON
    ...
    class EquitySnapshot(Base):
        ...
        __table_args__ = (Index("idx_equity_session_time", "session_id", "timestamp"),)
    ...
    class RiskEvent(Base):
        ...
        __table_args__ = (Index("idx_risk_events_session", "session_id"),)
